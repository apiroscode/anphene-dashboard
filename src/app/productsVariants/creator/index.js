...
import { GetProductVariants } from "../queries";

import { Header, Information, Summary, Tabs, Values } from "./_components";
...
export default () => {
  ...
  return (
    <QueryWrapper query={GetProductVariants} id={id} fieldName="product">
