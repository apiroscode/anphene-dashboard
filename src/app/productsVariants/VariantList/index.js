...
import { BulkDeleteVariant } from "../mutations";
import { ACTION, BulkDeleteVariants } from "./_components";
...
export const VariantList = ({ product }) => {
  ...
  const [bulkDelete, { loading }] = useMutation(BulkDeleteVariant);
