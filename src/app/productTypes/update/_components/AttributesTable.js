...
import { ReorderAttributes, UnassignAttribute } from "../../mutations";
...
const useStyles = makeStyles(
  ...
  { name: "ProductTypesAttributesTable" }
);
...
export const AttributesTable = (props) => {
  ...
  const [reorder, { loading: reorderLoading }] = useMutation(ReorderAttributes);
  const [unAssign, { loading: unAssignLoading }] = useMutation(UnassignAttribute);
  const {
    selected,
    setSelected,
    isSelected,
